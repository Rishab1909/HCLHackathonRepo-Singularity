...
│
├── models/
│   └── llama-3.2-3b-instruct.gguf  # Local GGUF model
│
├── artifacts/
...
│
├── src/
│   ├── chunk_text.py               # Splits document into chunks
│   ├── build_index.py              # Creates embeddings + FAISS
│   ├── retriever.py                # Vector search utilities
│   ├── generator.py                # Prompt builder + LLaMA inference
│   └── rag_pipeline.py             # End-to-end interface
│
├── requirements.txt
└── README.md
...
We will use top-k retrieval and low temprature, which makes the repsonse strict, preventing hallucination.
